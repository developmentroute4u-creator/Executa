        ...
        >
          <div className="prose prose-stone max-w-none text-stone-600 prose-headings:text-stone-900 prose-headings:font-bold prose-h2:text-2xl prose-h2:tracking-tight prose-h2:mt-10 prose-h2:mb-4 prose-p:leading-[1.7] prose-li:leading-[1.7]">
            ...
            <p className="lead text-lg font-medium text-stone-700">
              Welcome to FINDADE. These Terms of Service (&quot;Terms&quot;) govern your use of the FINDADE platform, operated by <strong>Route4U Technology LLP</strong> (&quot;FINDADE&quot;, &quot;we&quot;, &quot;our&quot;, or &quot;us&quot;). By creating an account or using our services, you agree to be bound by these Terms.
            </p>
            ...
            <p>
              ...
              <strong>Platform URL:</strong> <a href="https://findade.com" className="text-[#E85239] font-medium hover:underline">findade.com</a><br />
              ...
              <strong>Contact:</strong> <a href="mailto:support@findade.com" className="text-[#E85239] font-medium hover:underline">support@findade.com</a>
            </p>

            <h2>2. Eligibility &amp; User Accounts</h2>
            <ul>
              <li>You must be at least 18 years of age to use Findade.</li>
              ...
              <li>You must notify us immediately of any unauthorized use of your account at <a href="mailto:support@findade.com" className="text-[#E85239] font-medium hover:underline">support@findade.com</a>.</li>
              <li>Findade reserves the right to suspend or terminate accounts that violate these Terms.</li>
            </ul>

            <h2>3. Platform Services &amp; Pricing</h2>
            <p>Findade offers the following services:</p>
            <ul>
            ...
            <p><strong>Project Pricing:</strong> Total project costs on Findade are <strong>variable</strong> and depend on the type, scope, and complexity of work. Project budgets start from approximately <strong>₹10,000 INR</strong> and are determined through the AI-powered scoping process. The final cost is presented to the Client for review and approval before any payment is made.</p>
            ...
            <p>
              FINDADE is not a party to the contract between the Client and the Expert. Experts are independent contractors, not employees of Findade. FINDADE does not supervise, direct, or control the Expert&apos;s work beyond what is defined in the project scope document.
            </p>

            <h2>7. Intellectual Property</h2>
            <p>
              All intellectual property rights in the final delivered work transfer to the Client <strong>only upon full release of all milestone payments from escrow</strong>. Until payment is fully released, the Expert retains ownership of the work product. The AI-generated scope documents are owned by FINDADE and licensed to the Client for use on their specific project.
            </p>

            <h2>8. Prohibited Conduct</h2>
            <p>Users may not use Findade to:</p>
            <ul>
              <li>Circumvent the platform&apos;s payment system to conduct transactions outside FINDADE.</li>
            ...
            <ol>
              ...
              <li>Findade&apos;s mediation team will review within <strong>5–7 business days</strong> and issue a binding decision on fund release or refund.</li>
              <li>Findade&apos;s decision is final for platform-related disputes. Legal disputes are subject to Clause 12.</li>
            </ol>

            <h2>10. Platform Availability &amp; Modifications</h2>
            <p>
              FINDADE strives for 99% uptime but does not guarantee uninterrupted service. We reserve the right to modify, suspend, or discontinue any feature of the platform with reasonable notice. We are not liable for losses resulting from platform downtime.
            </p>

            <h2>11. Limitation of Liability</h2>
            <p>
              To the maximum extent permitted by applicable Indian law, FINDADE shall not be liable for:
            </p>
            <ul>
            ...
            <p>
              In accordance with the Information Technology Act, 2000, the following is the designated Grievance Officer for Findade:
            </p>
            <p>
            ...
            <p>
              We may update these Terms from time to time. Material changes will be notified via email or a platform announcement at least 7 days before taking effect. Continued use of Findade after the effective date constitutes acceptance of the revised Terms.
            </p>

            <hr className="my-10 border-stone-200" />
            <p className="text-sm text-stone-500">
              If you have questions about these Terms, contact us at{" "}
              <a href="mailto:legal@findade.com" className="text-[#E85239] font-medium hover:underline">legal@findade.com</a>. Also read our{" "}
