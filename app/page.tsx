          ...
          >
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-10 md:gap-20">
              ...
              >
                ...
                <p className="text-[14px] text-stone-500 font-medium leading-[1.7] max-w-[500px] mb-4">
                ...
                <p className="text-[12px] text-stone-400 font-medium mb-5">
                  Pricing varies by scope &mdash; projects start from <span className="text-stone-600 font-semibold">₹10,000</span>.{" "}
                  <Link href="/terms" className="text-[#E85239] hover:underline font-semibold">View pricing</Link>
                </p>
